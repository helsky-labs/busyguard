    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm animate-fade-in">
        <div className="text-center mb-10">
          ...
          <h1 className="text-heading-1 mt-6">Create your account</h1>
        ...
        <p className="mt-8 text-center text-body-sm text-content-secondary">
          ...
          <Link href="/auth/login" className="text-content-primary font-medium hover:underline underline-offset-4">
            Sign in
          </Link>
        </p>
      </div>
